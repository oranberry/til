...
// 함수를 호출할 때 넣은 값들을 인수라고 하고, 함수를 선언할 때 사용한 변수를 매개변수라고 한다. 
...
// 매개변수의 기본값은 무조건 undefined으로, 
// 매개변수에 대응하는 인수가 존재하지 않을 때 자동으로 undefined 값이 대입된다. 
// arguments로 호출 시 넣었던 인수 목록을 볼 수 있다. 화살표 함수 ❌ function으로 선언한 함수 ⭕️
function b(w, x, y, z){
