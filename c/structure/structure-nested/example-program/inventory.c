// This program illustrates how nested arrays and structures are used in practice.
// The program tracks parts stored in a warehouse. Information about the parts is stored in an array of structures.
// Seperate functions will perform the insert, search, update, and print operations.
...
// Conversion Specifications %m.pX or %-m.pX
// where m and p are integer constants and X is letter.
// minus sign (-) in front of m causes left justification.
// %6.2f, m is 6, p is 2, and X is f
