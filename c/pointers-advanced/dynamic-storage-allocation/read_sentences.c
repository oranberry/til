...
// Modify the reading a sentence example so that it reads in a series of sentences
// entered by the user and display them in sorted order.
...
// Use free function to release the block of memeory that were allocated to the sentences
